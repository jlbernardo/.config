...
ZSH_THEME_GIT_PROMPT_PREFIX="%{$fg_bold[cyan]%}[%{$fg_bold[green]%}⎇  %{$fg_bold[cyan]%}"
ZSH_THEME_GIT_PROMPT_SUFFIX="%{$fg_bold[cyan]%}]%{$reset_color%}"
ZSH_THEME_GIT_PROMPT_CLEAN="%{$fg_bold[green]%}✓ %{$reset_color%}"
ZSH_THEME_GIT_PROMPT_AHEAD="%B%F{069}▴ %{$reset_color%}"
ZSH_THEME_GIT_PROMPT_BEHIND="%B%F{183}▾ %{$reset_color%}"
ZSH_THEME_GIT_PROMPT_STAGED="%B%F{084}● %{$reset_color%}"
ZSH_THEME_GIT_PROMPT_UNSTAGED="%B%F{182}● %{$reset_color%}"
ZSH_THEME_GIT_PROMPT_UNTRACKED="%B%F{197}● %{$reset_color%}"
ZSH_THEME_GIT_PROMPT_STASHED="%B%F{214} ✹ %{$reset_color%}"
...
if [[ $EUID -eq 0 ]]; then
  ...
  _USERNAME="%{$fg_bold[white]%}%n"48
  _LIBERTY="%{$fg[green]%}$"
fi
_USERNAME="$_USERNAME AJF %{$reset_color%}@%m"
...
_1LEFT="$_PATH"
_1RIGHT="%{$fg_bold[cyan]%}[%{$fg_bold[green]%}%*%{$fg_bold[cyan]%}]"
